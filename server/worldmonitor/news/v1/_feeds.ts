...
// Central Asia (#5953) — Russia rear area, China BRI, sanctions leakage
  ...
  chile: {
    politics: [
      ...
      { name: 'T13', url: 'https://news.google.com/rss/search?q=site:t13.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'CNN Chile', url: 'https://news.google.com/rss/search?q=site:cnnchile.com+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: '24 Horas', url: 'https://news.google.com/rss/search?q=site:24horas.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'ADN Radio', url: 'https://news.google.com/rss/search?q=site:adnradio.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Diario Financiero', url: 'https://news.google.com/rss/search?q=site:df.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
    ...
    us: [
      ...
      { name: 'Ex-Ante', url: 'https://news.google.com/rss/search?q=site:ex-ante.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'El Líbero', url: 'https://news.google.com/rss/search?q=site:ellibero.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Interferencia', url: 'https://news.google.com/rss/search?q=site:interferencia.cl+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Radio U. de Chile', url: 'https://news.google.com/rss/search?q=site:radio.uchile.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Senado', url: 'https://news.google.com/rss/search?q=site:senado.cl+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Cámara de Diputados', url: 'https://news.google.com/rss/search?q=site:camara.cl+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'La Moneda', url: 'https://news.google.com/rss/search?q=("La+Moneda"+OR+"Presidente+de+la+República")+Chile+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'CIPER', url: 'https://news.google.com/rss/search?q=site:ciperchile.cl+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
    ],
    gov: [
      ...
      { name: 'SMA', url: 'https://news.google.com/rss/search?q=("Superintendencia+del+Medio+Ambiente"+OR+SMA+sanción)+Chile+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Tribunales Ambientales', url: 'https://news.google.com/rss/search?q="Tribunal+Ambiental"+Chile+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      ...
      { name: 'Contraloría', url: 'https://news.google.com/rss/search?q="Contraloría"+Chile+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Corte Suprema', url: 'https://news.google.com/rss/search?q=("Corte+Suprema"+OR+"Poder+Judicial")+Chile+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'CMF', url: 'https://news.google.com/rss/search?q=(CMF+OR+"Comisión+para+el+Mercado+Financiero")+Chile+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'SERNAGEOMIN / minería', url: 'https://news.google.com/rss/search?q=(SERNAGEOMIN+OR+"Ministerio+de+Minería"+OR+Codelco)+Chile+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Municipalidades', url: 'https://news.google.com/rss/search?q=(municipalidad+OR+alcalde+OR+concejo+municipal)+Chile+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
    ],
    climate: [
      ...
      { name: 'SENAPRED', url: 'https://news.google.com/rss/search?q=(SENAPRED+OR+"alerta+temprana+preventiva"+OR+evacuación)+Chile+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Meteorología', url: 'https://news.google.com/rss/search?q=("Dirección+Meteorológica"+OR+"sistema+frontal"+OR+ola+de+calor)+Chile+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Ladera Sur', url: 'https://news.google.com/rss/search?q=site:laderasur.com+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'País Circular', url: 'https://news.google.com/rss/search?q=site:paiscircular.cl+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'MMA', url: 'https://news.google.com/rss/search?q=site:mma.gob.cl+when:7d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Pueblos originarios', url: 'https://news.google.com/rss/search?q=(CONADI+OR+mapuche+OR+"consulta+indígena")+Chile+when:3d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
    ],
    latam: [
      ...
      { name: 'Regiones (SoyChile)', url: 'https://news.google.com/rss/search?q=site:soychile.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'El Día (Coquimbo)', url: 'https://news.google.com/rss/search?q=site:diarioeldia.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Mercurio de Valparaíso', url: 'https://news.google.com/rss/search?q=site:mercuriovalpo.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'El Sur (Concepción)', url: 'https://news.google.com/rss/search?q=site:elsur.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'Austral (Temuco/Valdivia)', url: 'https://news.google.com/rss/search?q=site:australtemuco.cl+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
      { name: 'El Pingüino (Magallanes)', url: 'https://news.google.com/rss/search?q=site:elpinguino.com+when:1d&hl=es-CL&gl=CL&ceid=CL:es', lang: 'es' },
    ],
  },
  happy: {
    positive: [
