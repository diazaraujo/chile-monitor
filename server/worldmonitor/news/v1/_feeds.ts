...
// Central Asia (#5953) — Russia rear area, China BRI, sanctions leakage
  ...
  // Chile Monitor (variante chile) — generado por scripts/chile-feeds-gen.py (espejo de CHILE_FEEDS)
  chile: {
    politics: [
      { name: 'Google News Chile', url: 'https://news.google.com/rss?hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'BioBio', url: 'https://news.google.com/rss/search?q=site:biobiochile.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Emol', url: 'https://news.google.com/rss/search?q=site:emol.com+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'La Tercera', url: 'https://news.google.com/rss/search?q=site:latercera.com+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Cooperativa', url: 'https://news.google.com/rss/search?q=site:cooperativa.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Mostrador', url: 'https://news.google.com/rss/search?q=site:elmostrador.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'T13', url: 'https://news.google.com/rss/search?q=site:t13.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'CNN Chile', url: 'https://news.google.com/rss/search?q=site:cnnchile.com+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: '24 Horas', url: 'https://news.google.com/rss/search?q=site:24horas.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'ADN Radio', url: 'https://news.google.com/rss/search?q=site:adnradio.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Diario Financiero', url: 'https://news.google.com/rss/search?q=site:df.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'La Segunda', url: 'https://news.google.com/rss/search?q=site:lasegunda.com+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'The Clinic', url: 'https://news.google.com/rss/search?q=site:theclinic.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Desconcierto', url: 'https://news.google.com/rss/search?q=site:eldesconcierto.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'CIPER', url: 'https://news.google.com/rss/search?q=site:ciperchile.cl+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
    ],
    us: [
      { name: 'Prensa Chile', url: 'https://news.google.com/rss/search?q=Chile+(gobierno+OR+congreso+OR+municipal)+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'La Tercera Política', url: 'https://news.google.com/rss/search?q=site:latercera.com+(política+OR+gobierno)+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Ex-Ante', url: 'https://news.google.com/rss/search?q=site:ex-ante.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Líbero', url: 'https://news.google.com/rss/search?q=site:ellibero.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Interferencia', url: 'https://news.google.com/rss/search?q=site:interferencia.cl+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Radio U. de Chile', url: 'https://news.google.com/rss/search?q=site:radio.uchile.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
    ...
    gov: [
      ...
      { name: 'SMA', url: 'https://news.google.com/rss/search?q=("Superintendencia+del+Medio+Ambiente"+OR+SMA+sanción)+Chile+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Tribunales Ambientales', url: 'https://news.google.com/rss/search?q="Tribunal+Ambiental"+Chile+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'DGA / agua', url: 'https://news.google.com/rss/search?q=(DGA+OR+"derechos+de+agua"+OR+"escasez+hídrica")+Chile+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Diario Oficial', url: 'https://news.google.com/rss/search?q=site:diariooficial.interior.gob.cl+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Contraloría', url: 'https://news.google.com/rss/search?q="Contraloría"+Chile+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Corte Suprema', url: 'https://news.google.com/rss/search?q=("Corte+Suprema"+OR+"Poder+Judicial")+Chile+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'CMF', url: 'https://news.google.com/rss/search?q=(CMF+OR+"Comisión+para+el+Mercado+Financiero")+Chile+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'SERNAGEOMIN / minería', url: 'https://news.google.com/rss/search?q=(SERNAGEOMIN+OR+"Ministerio+de+Minería"+OR+Codelco)+Chile+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Municipalidades', url: 'https://news.google.com/rss/search?q=(municipalidad+OR+alcalde+OR+concejo+municipal)+Chile+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
    ],
    climate: [
      { name: 'Clima Chile', url: 'https://news.google.com/rss/search?q=Chile+(sequía+OR+inundación+OR+glaciar+OR+humedal+OR+CONAF)+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Incendios CONAF', url: 'https://news.google.com/rss/search?q=Chile+(incendio+forestal+OR+CONAF+OR+"alerta+roja")+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'SENAPRED', url: 'https://news.google.com/rss/search?q=(SENAPRED+OR+"alerta+temprana+preventiva"+OR+evacuación)+Chile+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Meteorología', url: 'https://news.google.com/rss/search?q=("Dirección+Meteorológica"+OR+"sistema+frontal"+OR+ola+de+calor)+Chile+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Ladera Sur', url: 'https://news.google.com/rss/search?q=site:laderasur.com+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'País Circular', url: 'https://news.google.com/rss/search?q=site:paiscircular.cl+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'MMA', url: 'https://news.google.com/rss/search?q=site:mma.gob.cl+when:7d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Pueblos originarios', url: 'https://news.google.com/rss/search?q=(CONADI+OR+mapuche+OR+"consulta+indígena")+Chile+when:3d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
    ],
    latam: [
      { name: 'Cono Sur', url: 'https://news.google.com/rss/search?q=(Chile+OR+Argentina+OR+Perú+OR+Bolivia)+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Regiones (SoyChile)', url: 'https://news.google.com/rss/search?q=site:soychile.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Día (Coquimbo)', url: 'https://news.google.com/rss/search?q=site:diarioeldia.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Mercurio de Valparaíso', url: 'https://news.google.com/rss/search?q=site:mercuriovalpo.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Sur (Concepción)', url: 'https://news.google.com/rss/search?q=site:elsur.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'Austral (Temuco/Valdivia)', url: 'https://news.google.com/rss/search?q=site:australtemuco.cl+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
      { name: 'El Pingüino (Magallanes)', url: 'https://news.google.com/rss/search?q=site:elpinguino.com+when:1d&hl=es-419&gl=CL&ceid=CL:es-419', lang: 'es' },
    ],
  },
  happy: {
    positive: [
