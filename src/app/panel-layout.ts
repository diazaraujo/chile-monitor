 ...
 *
 * `live-news` and `climate` are the current entries. CANONICAL_FEEDS['live-news'] exists to seed the
 ...
 */
const LATE_REGISTERED_PANEL_KEYS = new Set(['live-news', 'climate', 'climate-news']);
